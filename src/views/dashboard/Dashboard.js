        ...
        <CCardBody>
          <CRow>
            <CCol sm="5">
              ...
              <div className="small text-muted">شهریور 1400</div>
            </CCol>
        ...
        <CCardFooter>
          <CRow className="text-center">
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">منحصر بفرد</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">بازدید صفحات</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">کاربران جدیدالورود</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">نرخ پرش</div>
              <strong>میانگین نرخ (40.15%)</strong>
              <CProgress
                className="progress-xs mt-2"
                precision={1}
                value={40}

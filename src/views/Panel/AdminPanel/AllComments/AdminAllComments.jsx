...
import { ADMIN_ALLCOMMENTSCOLUMNS } from "./AdminAllCommentsColumn";
import { AllComments } from "src/core/services/api/comment.api";
import { toast } from "react-toastify";
import PreRingLoader from "src/component/common/PreLoader/PreRingLoader";
import { ReactTableFiltedredRowsData } from "../../../../component/UserPanel/ReactTableComponent/ReactTableComponent";
...
import styles from "./AdminAllComments.module.css";
...
const AdminAllComments = () => {
  ...
  const columns = useMemo(() => ADMIN_ALLCOMMENTSCOLUMNS, []);

...
import { ADMIN_ALLNEWSCOLUMNS } from "./AdminAllNewsColumns";
import { getAllNews } from "src/core/services/api/news.api";
...
import styles from "./AdminAllNews.module.css";
...
const AdminAllNews = () => {
  ...
  const columns = useMemo(() => ADMIN_ALLNEWSCOLUMNS, []);
